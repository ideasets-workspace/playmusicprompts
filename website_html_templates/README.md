# PlayMusicPrompts — HTML templates
...
Windows’ta **START.cmd** dosyasını aç. Yerel önizleme: **http://127.0.0.1:4173**. Bu bilgisayardaki Node.js veya Codex ile gelen Node.js otomatik bulunur.
