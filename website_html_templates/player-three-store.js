export const ROOM_STORE_KEYS = Object.freeze({
  preferences: 'pmp.room.preferences.v2',
  session: 'pmp.room.session.v2'
});
...
export function createRoomStore(storage, tabId) {
  ...
  // keep writing pmp.room without changing either migrated v2 record.
  const legacy = !storedPreferences || !storedSession ? read('pmp.room') || {} : {};
