export const ROOM_STORE_KEYS = Object.freeze({
  preferences: 'pmp.beyond.room.preferences.v2',
  session: 'pmp.beyond.room.session.v2'
});
...
export function createRoomStore(storage, tabId) {
  ...
  // keep writing pmp.beyond.room without changing either migrated v2 record.
  const legacy = !storedPreferences || !storedSession ? read('pmp.beyond.room') || {} : {};
