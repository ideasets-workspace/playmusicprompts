...
const names=['THREE','createSceneCollection','createAudioFeatures','createOpticsPass','getWorld','OrbitControls','EffectComposer','RenderPass','UnrealBloomPass','OutputPass','ShaderPass','VISUAL_DEFAULTS','sanitizeVisualSettings','Reflector','RoomEnvironment'];
...
const prefix=names.map(name=>name==='THREE'||name==='VISUAL_DEFAULTS'
  ...
  : ['createSceneCollection','createAudioFeatures','createOpticsPass','getWorld','sanitizeVisualSettings'].includes(name)
