export const ROOM_STORE_KEYS = Object.freeze({
  preferences: 'pmp.lab.room.preferences.v2',
  session: 'pmp.lab.room.session.v2'
});
...
export function createRoomStore(storage, tabId) {
  ...
  // keep writing pmp.lab.room without changing either migrated v2 record.
  const legacy = !storedPreferences || !storedSession ? read('pmp.lab.room') || {} : {};
